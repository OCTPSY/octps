...
from(
	...
	select
		 w1.date
		, w1.cash_and_equivalents as "mnfctr_cash_and_equivalents"
		, w1.accounts_receivable_net as "mnfctr_accounts_receivable_net"
		, w1."inventories.1" as "mnfctr_inventories"
		, w1.total_current_assets as "mnfctr_total_current_assets"
		, w1.property_plant_and_equipment_net as "mnfctr_property_plant_and_equipment_net"
		, w1.goodwill as "mnfctr_goodwill"
		, w1.intangible_assets_net as "mnfctr_intangible_assets"
		, w1."assets.2" as "mnfctr_total_assets"
		, w1.current_portion_of_long_term_debt as "mnfctr_short_term_debt"
		, null as "mnfctr_short_term_unearned_revenue"
		, w1.accounts_payable as "mnfctr_accounts_payable"
		, w1.total_current_liabilities as "mnfctr_total_current_liabilities"
		, null as "mnfctr_long_term_unearned_revenue"
		, w1.long_term_debt as "mnfctr_long_term_debt"
		, w1.debt as "mnfctr_total_debt"
		, w1."total_liabilities.1" as "mnfctr_total_liabilities"
		, w1."cash_and_equivalents.1" as "fin_cash_and_equivalents"
		, w1.finance_receivables_net as "fin_finance_receivables_net"
		, w1."assets.3" as "fin_total_assets"
		, w1.debt as "fin_total_debt"
		, w1."total_liabilities.2" as "fin_total_liabilities"
		, coalesce( w1.common_stock_219_2_million_and_231_0_million_shares_issued_respectively_and_216_9_million_and_226_4_million_shares_outstanding_respectively, 0 )
		  ...
		  as "group_total_paid_in_capital"
		, w1.treasury_stock as "group_treasury_stock"
		, w1.retained_earnings as "group_retained_earnings"
		, w1.total_shareholders_equity as "group_total_shareholder_equity"
		, null as "group_non_controlling_interest"
		, w1.total_liabilities_and_shareholders_equity as "group_total_liabilities_and_equity"
	from
	...
	select
		...
		, w1.goodwill as "mnfctr_goodwill"
		, w1.intangible_assets_net as "mnfctr_intangible_assets"
		, w1."total_assets.1" as "mnfctr_total_assets"
		, w1.current_portion_of_long_term_debt as "mnfctr_short_term_debt"
		, w1.accounts_payable as "mnfctr_accounts_payable"
		, w1.total_current_liabilities as "mnfctr_total_current_liabilities"
		, w1.long_term_debt as "mnfctr_long_term_debt"
		...
		, w1."cash_and_equivalents.1" as "fin_cash_and_equivalents"
		, w1.finance_receivables_net as "fin_finance_receivables_net"
		, w1."total_assets.2" as "fin_total_assets"
		, w1."debt.1" as "fin_total_debt"
		, w1."total_liabilities.2" as "fin_total_liabilities"
	...
	select
		 w1.date
		, w1."cash_and_equivalents.1" as "mnfctr_cash_and_equivalents"
		, w1.accounts_receivable_net as "mnfctr_accounts_receivable_net"
		, w1."inventories" as "mnfctr_inventories"
		, w1.total_current_assets as "mnfctr_total_current_assets"
		, w1.property_plant_and_equipment_net as "mnfctr_property_plant_and_equipment_net"
		, w1.goodwill as "mnfctr_goodwill"
		, w1.intangible_assets_net as "mnfctr_intangible_assets"
		, w1."total_assets.1" as "mnfctr_total_assets"
		, w1.short_term_debt_and_current_portion_of_long_term_debt as "mnfctr_short_term_debt"
		, w1.accounts_payable as "mnfctr_accounts_payable"
		, w1.total_current_liabilities as "mnfctr_total_current_liabilities"
		, w1.long_term_debt as "mnfctr_long_term_debt"
		, w1.debt as "mnfctr_total_debt"
		, w1."total_liabilities.1" as "mnfctr_total_liabilities"
		, w1."cash_and_equivalents.2" as "fin_cash_and_equivalents"
		, w1.finance_receivables_net as "fin_finance_receivables_net"
		, w1."total_assets.2" as "fin_total_assets"
		, w1."debt.1" as "fin_total_debt"
		, w1."total_liabilities.2" as "fin_total_liabilities"
