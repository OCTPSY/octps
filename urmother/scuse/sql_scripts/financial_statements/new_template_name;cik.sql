...
--	CENTRAL INDEX KEY : <<insert cik>>
--=====================================================

with
	temp_balance_sheet as(
		--UPDATE HERE
		select 'CVNA;1690820' as "ticker_cik", '10_K2022_02_24_CONSOLIDATED_BALANCE_SHEETS_13807322671865' as "table_name", date as "date",  ( (  + cast( coalesce( "cash_and_cash_equivalents", 0 ) as float ) + cast( coalesce( "restricted_cash", 0 ) as float ) ) / 1 ) as "cash_and_equivalents", ( (  + cast( coalesce( "accounts_receivable_net", 0 ) as float ) + cast( coalesce( "finance_receivables_held_for_sale_net", 0 ) as float ) ) / 1 ) as "accounts_receivable_net", ( (  + cast( coalesce( "vehicle_inventory", 0 ) as float ) ) / 1 ) as "inventories", ( (  + cast( coalesce( "total_current_assets", 0 ) as float ) ) / 1 ) as "total_current_assets", ( (  + cast( coalesce( "property_and_equipment_net", 0 ) as float ) + cast( coalesce( "operating_lease_right_of_use_assets_including_17_and_22_respectively_from_leases_with_related_parties", 0 ) as float ) ) / 1 ) as "property_plant_and_equipment_net", ( (  + cast( coalesce( "goodwill", 0 ) as float ) ) / 1 ) as "goodwill", ( (  + cast( coalesce( "intangible_assets_net", 0 ) as float ) ) / 1 ) as "intangible_assets", ( (  + cast( coalesce( "total_assets", 0 ) as float ) ) / 1 ) as "total_assets", ( (  + cast( coalesce( "short_term_revolving_facilities", 0 ) as float ) + cast( coalesce( "current_portion_of_long_term_debt", 0 ) as float ) ) / 1 ) as "short_term_debt", ( null ) as "short_term_unearned_revenue", ( (  + cast( coalesce( "accounts_payable_and_accrued_liabilities_including_27_and_16_respectively_due_to_related_parties", 0 ) as float ) ) / 1 ) as "accounts_payable", ( (  + cast( coalesce( "total_current_liabilities", 0 ) as float ) ) / 1 ) as "total_current_liabilities", ( null ) as "long_term_unearned_revenue", ( (  + cast( coalesce( "long_term_debt_excluding_current_portion", 0 ) as float ) + cast( coalesce( "operating_lease_liabilities_excluding_current_portion_including_13_and_19_respectively_from_leases_with_related_parties", 0 ) as float ) ) / 1 ) as "long_term_debt", ( null ) as "total_debt", ( (  + cast( coalesce( "total_liabilities", 0 ) as float ) ) 
/ 1 ) as "total_liabilities", ( (  + cast( coalesce( "additional_paid_in_capital", 0 ) as float ) ) / 1 ) as "total_paid_in_capital", ( null ) as "treasury_stock", ( (  + cast( coalesce( "accumulated_deficit", 0 ) as float ) ) / 1 ) as "retained_earnings", ( (  + cast( coalesce( "total_stockholders_equity_attributable_to_carvana_co", 0 ) as float ) ) / 1 ) as "total_shareholder_equity", ( (  + cast( coalesce( "non_controlling_interests", 0 ) as float ) ) / 1 ) as "non_controlling_interest", ( (  + cast( coalesce( "total_liabilities_stockholders_equity", 0 ) as float ) ) / 1 ) as "total_liabilities_and_equity", ( null ) as "common_stock_shares_outstanding" from "10_K2022_02_24_CONSOLIDATED_BALANCE_SHEETS_13807322671865" union all select 'CVNA;1690820' as "ticker_cik", '10_K2020_02_26_CONSOLIDATED_BALANCE_SHEETS_13807320657106' as "table_name", date as "date",  ( (  + cast( coalesce( "cash_and_cash_equivalents", 0 ) as float ) + cast( coalesce( "restricted_cash", 0 ) as float ) ) / 1000 ) as "cash_and_equivalents", ( (  + cast( coalesce( "accounts_receivable_net", 0 ) as float ) + cast( coalesce( "finance_receivables_held_for_sale_net", 0 ) as float ) ) / 1000 ) as "accounts_receivable_net", ( (  + cast( coalesce( "vehicle_inventory", 0 ) as float ) ) / 1000 ) as "inventories", ( (  + cast( coalesce( "total_current_assets", 0 ) as float ) ) / 1000 ) as "total_current_assets", ( (  + cast( coalesce( "property_and_equipment_net", 0 ) as float ) + cast( coalesce( "property_and_equipment_net.1", 0 ) as float ) + cast( coalesce( "operating_lease_right_of_use_assets_including_44583_and_0_respectively_from_leases_with_related_parties", 0 ) as float ) ) / 1000 ) as "property_plant_and_equipment_net", ( (  + cast( coalesce( "goodwill", 0 ) as float ) ) / 1000 ) as "goodwill", ( (  + cast( coalesce( "intangible_assets_net", 0 ) as float ) ) / 1000 ) as "intangible_assets", ( (  + cast( coalesce( "total_assets", 0 ) as 
float ) ) / 1000 ) as "total_assets", ( (  + cast( coalesce( "short_term_revolving_facilities", 0 ) as float ) + cast( coalesce( "current_portion_of_long_term_debt", 0 ) as float ) ) / 1000 ) as "short_term_debt", ( null ) as "short_term_unearned_revenue", ( (  + cast( coalesce( "accounts_payable_and_accrued_liabilities_including_9549_and_3891_respectively_due_to_related_parties", 0 ) 
as float ) ) / 1000 ) as "accounts_payable", ( (  + cast( coalesce( "total_current_liabilities", 
0 ) as float ) ) / 1000 ) as "total_current_liabilities", ( null ) as "long_term_unearned_revenue", ( (  + cast( coalesce( "long_term_debt_excluding_current_maturities", 0 ) as float ) + cast( coalesce( "operating_lease_liabilities_excluding_current_portion_including_41829_and_0_respectively_from_leases_with_related_parties", 0 ) as float ) ) / 1000 ) as "long_term_debt", ( null ) as "total_debt", ( (  + cast( coalesce( "total_liabilities", 0 ) as float ) ) / 1000 ) as "total_liabilities", ( (  + cast( coalesce( "additional_paid_in_capital", 0 ) as float ) ) / 1000 ) as "total_paid_in_capital", ( null ) as "treasury_stock", ( (  + cast( coalesce( "accumulated_deficit", 0 ) as float ) ) / 1000 ) as "retained_earnings", ( (  + cast( coalesce( "total_stockholders_equity_attributable_to_carvana_co", 0 ) as float ) ) / 1000 ) as "total_shareholder_equity", ( (  + cast( coalesce( "non_controlling_interests", 0 ) as float ) ) / 1000 ) as "non_controlling_interest", ( (  + cast( coalesce( "total_liabilities_stockholders_equity", 0 ) as float ) ) / 1000 ) as "total_liabilities_and_equity", ( null ) as "common_stock_shares_outstanding" from "10_K2020_02_26_CONSOLIDATED_BALANCE_SHEETS_13807320657106" union all select 'CVNA;1690820' as "ticker_cik", '10_K2018_03_06_CONSOLIDATED_BALANCE_SHEETS_13807318670856' as "table_name", date as "date",  ( (  + cast( coalesce( "cash_and_cash_equivalents", 0 ) as float ) + cast( coalesce( "restricted_cash", 0 ) as float ) ) / 1000 ) as "cash_and_equivalents", ( (  + cast( coalesce( "accounts_receivable_net", 0 ) as float ) + cast( coalesce( "finance_receivables_held_for_sale_net", 0 ) as float ) ) / 1000 ) as "accounts_receivable_net", ( (  + cast( coalesce( "vehicle_inventory", 0 ) as float 
) ) / 1000 ) as "inventories", ( (  + cast( coalesce( "total_current_assets", 0 ) as float ) ) / 
1000 ) as "total_current_assets", ( (  + cast( coalesce( "property_and_equipment_net", 0 ) as float ) ) / 1000 ) as "property_plant_and_equipment_net", ( null ) as "goodwill", ( null ) as "intangible_assets", ( (  + cast( coalesce( "total_assets", 0 ) as float ) ) / 1000 ) as "total_assets", ( (  + cast( coalesce( "current_portion_of_long_term_debt", 0 ) as float ) ) / 1000 ) as "short_term_debt", ( null ) as "short_term_unearned_revenue", ( (  + cast( coalesce( "accounts_payable_and_accrued_liabilities", 0 ) as float ) + cast( coalesce( "accounts_payable_due_to_related_party", 0 ) as float ) ) / 1000 ) as "accounts_payable", ( (  + cast( coalesce( "total_current_liabilities", 0 ) as float ) ) / 1000 ) as "total_current_liabilities", ( null ) as "long_term_unearned_revenue", ( (  + cast( coalesce( "long_term_debt_excluding_current_portion", 0 ) as float ) ) / 1000 ) as "long_term_debt", ( null ) as "total_debt", ( (  + cast( coalesce( "total_liabilities", 
0 ) as float ) ) / 1000 ) as "total_liabilities", ( (  + cast( coalesce( "additional_paid_in_capital", 0 ) as float ) ) / 1000 ) as "total_paid_in_capital", ( null ) as "treasury_stock", ( (  + 
cast( coalesce( "accumulated_deficit", 0 ) as float ) ) / 1000 ) as "retained_earnings", ( (  + cast( coalesce( "total_stockholders_equity_attributable_to_carvana_co", 0 ) as float ) + cast( coalesce( "total_members_deficit_attributable_to_carvana_co", 0 ) as float ) ) / 1000 ) as "total_shareholder_equity", ( (  + cast( coalesce( "non_controlling_interests", 0 ) as float ) ) / 1000 ) 
as "non_controlling_interest", ( (  + cast( coalesce( "total_liabilities_temporary_equity_stockholders_equity_members_deficit", 0 ) as float ) ) / 1000 ) as "total_liabilities_and_equity", ( null ) as "common_stock_shares_outstanding" from "10_K2018_03_06_CONSOLIDATED_BALANCE_SHEETS_13807318670856"
	)
	,
