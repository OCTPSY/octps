...
company_CIKs = [ '100517' ]    ##UPDATE HERE ##['1018724', '1318605', '789019']
                            ...
                            pd.read_sql_query(
                                 """
                                    ...
                                    from
                                        filing_list a
                                    inner join
                                        individual_report_links b on
                                             a.filing_number = b.filing_number
                                    where
                                         b.report_url like '%.htm%'
                                    and
                                         a.cik = ?
                                    and
                                         a.filing_type = ?
                                    and
                                         a.filing_date between ? and ?
                                    and(
                                        --TAKING ONLY MAIN FINANCIAL STATEMENTS AND DEPRECIATION DETAILS
                                         lower( b.short_name ) like '%depreciation%'
                                            or
                                         lower( b.short_name ) like '%consolidated%'
                                            or
                                         lower( b.short_name ) like '%property%'
                                    )
                                    order by
                                         a.filing_date desc
                                 """
...
start_mth_date = '-01-01'
end_mth_date = '-12-31'

for year in years:
    start_date = year + start_mth_date
    end_date = year + end_mth_date
